...
def init_db() -> None:
    with get_db() as conn:
        ...
        # Seed settings
        default_settings = [
            ("max_upload_size_mb", "50", "Taille maximale d'upload (Mo)"),
            ("max_docs_per_session", "10", "Documents max par session"),
            ("allow_registration", "true", "Autoriser les inscriptions"),
            ("default_role", "student", "Rôle par défaut"),
            ("system_prompt", config.RAG_SYSTEM_PROMPT, "Prompt système"),
            (
                "public_assistant_enabled",
                "false",
                "Assistant public activé",
                "Affiche l'assistant de la page d'accueil quand un contexte public est configuré.",
                "boolean",
            ),
            (
                ...
                "",
                "Contexte public",
                "Connaissances publiques validées par l'administration. L'assistant d'accueil répond uniquement à partir de ce contexte.",
                "textarea",
            ),
            (
                "public_assistant_instructions",
                "Sois concis, utile et clair. Réponds dans la langue du visiteur quand c'est possible.",
                "Instructions de l'assistant public",
                "Consignes de comportement et de ton ajoutées aux règles d'ancrage.",
                "textarea",
            ),
            (
                ...
                "Message d'accueil de l'assistant public",
                "Message affiché à l'ouverture de l'assistant d'accueil.",
                "textarea",
            ),
            (
                "public_assistant_placeholder",
                "Posez une question sur ENSET AI...",
                "Texte de saisie de l'assistant public",
                "Placeholder du champ de saisie pour les visiteurs.",
                "text",
            ),
            (
                ...
                "Message de refus de l'assistant public",
                "Message utilisé quand une réponse n'est pas couverte par le contexte public.",
                "textarea",
            ),
            (
                "public_assistant_suggested_questions",
                "",
                "Questions suggérées de l'assistant public",
                "Questions de départ facultatives, une par ligne. L'interface publique en affiche jusqu'à trois.",
                "textarea",
            ),
            (
                "public_assistant_provider",
                "auto",
                "Fournisseur de l'assistant public",
                "Fournisseur utilisé globalement pour le trafic anonyme de l'assistant d'accueil.",
                "select",
            ),
            (
                "public_assistant_model",
                "auto",
                "Modèle de l'assistant public",
                "Modèle utilisé globalement pour le trafic anonyme de l'assistant d'accueil.",
                "select",
            ),
            (
                "public_assistant_rate_limit_per_hour",
                "30",
                "Limite horaire de l'assistant public",
                "Nombre de requêtes anonymes autorisées par IP et par heure.",
                "number",
            ),
        ]
